...
def index():
    if request.method == 'POST':
        ...
        try:
            ...
            if -1 > 0: # if there is a collection with searched keyword and it has records in it
...
if __name__ == "__main__":
    app.run(port=2000,debug=True) # running the app on the local machine on port 8000